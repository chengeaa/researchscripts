...
class ED:
    def __init__(self, aspect='equal', linewidth = 1):
        # plot parameters
        self.ratio = 1.6181
        self.dimension = 'auto'
        self.space = 'auto'
    ...
    def plot(self, show_IDs=False):
        ...
        ax.spines['left'].set_linewidth(self.linewidth/2)
        ax.tick_params(width=self.linewidth/2, length = 5)
        ...
        for level in data:
            ...
            ax.hlines(level[0], start, start + self.dimension, color=level[4], linewidth=self.linewidth)
